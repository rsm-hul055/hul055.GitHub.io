...
compare_df = pd.DataFrame({
    "Parameter": ["price", "brand_N", "brand_P", "ad_Yes"],
    "MLE Estimate": [mle_values[p][0] for p in mle_values],
    "MLE Std. Error": [mle_values[p][1] for p in mle_values],
    "Bayes Mean": summary_df["mean"].values,
    "Bayes Std. Dev": summary_df["std"].values
})
